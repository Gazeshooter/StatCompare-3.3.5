...
function SC_Localization_enUS()
	...
	STATCOMPARE_DAMAGEREDUCE = "Damage Reduction";
	...
	STATCOMPARE_DEFENSE	= "Defense Skill";
	STATCOMPARE_STEALTH	= "Stealth";
	STATCOMPARE_SWIMMING	= "Swim Speed";
		
	STATCOMPARE_BLOCK	= "Block Value";
	STATCOMPARE_TOBLOCK	= "Block %";
	...
	STATCOMPARE_EXPERTISERATING = "Expertise";
	STATCOMPARE_RESILIENCERATING = "Resilience";
	STATCOMPARE_DEFENSERATING = "Defense";
	STATCOMPARE_DODGERATING = "Dodge";
	STATCOMPARE_PARRYRATING = "Parry";
	STATCOMPARE_BLOCKRATING = "Block";
	STATCOMPARE_SPELLPOWER = "Spell Power";
	STATCOMPARE_SPELLPENETRATION = "Spell Penetration";
	STATCOMPARE_RANGEDCRITRATING = "Ranged Critical";
